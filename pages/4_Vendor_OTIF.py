...
Original file is located at
    https://colab.research.google.com/drive/1L0AM8GxQF43K4jHfkFYXh-2J5p5yVho3
"""

# pages/4_OTIF_Analysis.py
# Updated Streamlit OTIF analysis with Vendor OTIF % and Vendor Contribution % in Top-10 and PDF
...
# vendor statistics for the year
...
if breaches.empty:
    ...
    top10 = pd.DataFrame(columns=["Supplier", "OTIF_Failures", "Vendor_OTIF_pct", "Total_Contribution_pct", "Total_Orders"])
    ...
    # PDF download (show vendor OTIF and contribution in headings)
